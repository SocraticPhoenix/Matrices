...
public class ByteRowHandler implements RowHandler<Byte, byte[],
    ...
    @Override
    public int hashCode(byte[] row, int from, int to) {
        int res = 0;
    ...
    @Override
    public String toString(byte[] row, int from, int to) {
    ...
    @Override
    public boolean equals(byte[] rowA, int fromA, int toA, byte[] rowB, int fromB) {
